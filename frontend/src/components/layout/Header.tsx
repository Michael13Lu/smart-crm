      ...
      <header className="flex items-center justify-between h-16 px-6 bg-white border-b border-gray-200 shrink-0">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="hidden md:flex items-center gap-2 px-3 py-1.5 bg-gray-100 rounded-lg text-sm text-gray-500 w-56 cursor-pointer hover:bg-gray-200 transition-colors"
          >
            <Search className="w-4 h-4" />
            <span>Search leads, deals…</span>
            <kbd className="ml-auto text-xs text-gray-400 font-medium">⌘K</kbd>
          </button>
